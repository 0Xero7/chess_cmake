...
int main()
{
	...
	//Board board("1bk5/2b5/7b/4B3/5b1B/B2K4/3B4/8"); // "1r6/2r2k2/7r/4R3/3K1r2/8/R2R2R1/8"); // 1r5k / pp5p / 2p3p1 / 5b2 / 2q5 / P3Q3 / 1PP4P / 2K1R3");// 7k / 8 / R7 / R7 / 8 / 5K2 / 8 / 8");// "6k1 / 4Q3 / 8 / 6K1 / 8 / 8 / 8 / 8");// "rnbqkbnr / pppppppp / 8 / 8 / 8 / 8 / PPPPPPPP / RNBQKBNR");// "5k2 / 8 / 8 / 8 / 2n5 / 8 / 2K5 / n7"); // ("4k3 / 8 / 8 / 8 / nnn5 / nKn5 / 8 / 8");
	...
	for (int i = 0; i <= 100000; ++i) {
		...
		rboard.get_rook_moves<WHITE>(collect);
	...
	for (int i = 0; i <= 100000; ++i) {
		...
		rboard.get_fast_rook_moves<WHITE>(collect2);
